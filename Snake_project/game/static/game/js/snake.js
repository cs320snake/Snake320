...
SNAKE.Snake = SNAKE.Snake || (function() {
    ...
    */
    return function(config) {
        ...
        // ----- private variables (I am feeling the pain of trying to make this work) -----
    ...
    */
    ...
    return function(inputConfig) {
        ...
        function createWelcomeElement() {
            ...
            welcomeTxt.innerHTML = "Snake Project<p></p>Use the <strong>arrow keys</strong> on your keyboard to play the game. " + fullScreenText + "<p></p>";
    ...
    }; // end return function. This concludes my work.
})();  
